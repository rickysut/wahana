...
@section('content')
    ...
    <div class="flex min-h-screen flex-col items-center justify-center gap-x-8 gap-y-8 py-8 px-4 md:flex-row lg:gap-x-12">
        <div class="shrink-0">
            <img src="{{ asset('vendor/moonshine/not-found.svg') }}"
                 class="h-28  xs:h-36 md:h-56 lg:h-60"
                 alt="MoonShine"
            />
        </div>
        <div class="text-center md:text-left">
            <div class="space-y-3">
                <h1 class="text-2xl animate-wiggle font-bold leading-none text-white lg:text-3xl">{{ $code }}</h1>
